...
command =  matrix(c(
    ...
    "noCnet",    "b",  0,   "logical",      "skip GO cnet plots",
...
if (args$type == "GO") {
  ...
  ## print to pdf
  p <- dotplot(geneEnrich, showCategory = args$max, font.size = 10)
  PlotSave(dotplotPdf, p)
