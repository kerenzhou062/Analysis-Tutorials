...
bedToBigBed -as=${pipepath}/encode/dnase-call-hotspots/broadPeak.as -type=bed6+3 ${hotspot_root}.bed $chrom_sizes ${hotspot_root}.bb
...
bedToBigBed -as=${pipepath}/encode/dnase-call-hotspots/narrowPeak.as -type=bed6+4 ${peaks_root}.bed $chrom_sizes ${peaks_root}.bb
