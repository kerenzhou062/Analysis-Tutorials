...
parser.add_argument('-nolambda', action='store_true',
                    default=False,
                    help='macs2 call peaks with "--nolambda" parameter')
...
def runMacs2(ip, control, name, other, output,
             extsize, gsize, shift, pval, nolambda,
    ...
    macs2Command = 'macs2 callpeak -t {ip} \
        ...
        -p {pval} --nomodel --shift {shift} {nolambda} \
